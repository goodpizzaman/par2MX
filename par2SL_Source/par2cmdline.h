...
#define PACKAGE "par2SL"    /* Program name */
#define VERSION "1.0"       /* Program version no. */

#include <dispatch/dispatch.h>  /* The Grand Central stuff */
#include <stdlib.h>
#include <stdio.h>
#include <dirent.h>
...
// The program uses multiple threads during repair and creation. Each thread can write
// one or more lines to stdout and stderr. However, each such line can be created with
// multiple calls of the << operator. The next semaphore can be used to guarantee the lines
// are not interrupted by other lines from different threads.
extern dispatch_semaphore_t coutSema;
